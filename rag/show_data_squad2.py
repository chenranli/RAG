...
print(f"length of squad_v2 training dataset: {len(squad_v2['train'])}\n")
...
print(f"{squad_v2['train'][args.arg1]}\n")
print(f"context: {squad_v2['train'][args.arg1]['context']}\n")
print(f"question: {squad_v2['train'][args.arg1]['question']}\n")
print(f"answers: {squad_v2['train'][args.arg1]['answers']}\n")
print(f"answers_text: {squad_v2['train'][args.arg1]['answers']['text']}\n")