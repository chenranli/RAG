...
random_indices = random.sample(range(1, 10000), 500)
results = []
...
for index in random_indices:
    ...
    time1 = time.time()
    passages, titles, _= search_vectordb(question, collection, embedding_model, 5)
    time2 = time.time()
...
file_path = 'lcr_pas_sen_0_10000_500.txt'
# Write to file
